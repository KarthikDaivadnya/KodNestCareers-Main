  ...
  projects: [
    {
      ...
      description:
        'A Lovable + GPT-4o powered tool that auto-tailors resumes to job descriptions and shows real-time ATS score.',
    ...
    },
    {
      ...
      description:
        'KodNest internal tool for JD analysis, skill extraction, and 7-day interview prep planning.',
      link: 'https://github.com/karthikdaivadnya/prp',
    },
  ],
  skills: 'React, TypeScript, Node.js, PostgreSQL, Tailwind CSS, Docker, AWS, Git, GPT-4o, Vite',
