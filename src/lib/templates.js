/**
 * Template system — 3 visual styles for the resume document.
 * Layout only — content and scoring are never affected.
 */
...
/**
 * Style map per template. Only visual tokens — no logic.
 */
export const TEMPLATE_STYLES = {
  classic: {
    ...
    nameClass:     'text-[22px] font-bold tracking-tight text-gray-950',
  ...
  modern: {
    ...
    headerBorder:  'mb-5',
    nameClass:     'text-[21px] font-bold tracking-tight text-gray-950',
  ...
  minimal: {
    ...
    headerAlign:   'text-left',
    headerBorder:  'mb-4',
    nameClass:     'text-[18px] font-semibold tracking-tight text-gray-900',
